function(mig filename)
    cmake_parse_arguments(MIG "NOVOUCHERS;NODEFINES" "INCLUDES_FROM_TARGET;INCLUDE_DIRECTORY;USER_HEADER;USER_SOURCE;SERVER_HEADER;SERVER_SOURCE;ARCH" "" ${ARGN})
    ...
    if(MIG_INCLUDE_DIRECTORY)
        list(APPEND MIG_FLAGS -I${MIG_INCLUDE_DIRECTORY})
    endif()
